...
// Append buttons to page. The number of pages to show is found from the pageList.length.
...
// append pagination class to html at the bottom
appendButtons(studentList);


// Search function finds both name and/or email. If no results are found,
// change the header H2 to display No Results, otherwise display default Students title.
